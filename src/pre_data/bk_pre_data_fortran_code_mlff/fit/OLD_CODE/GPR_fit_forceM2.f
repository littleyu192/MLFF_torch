       ...
       real*8,allocatable,dimension(:,:) :: dist0_ref
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       enddo
       read(10,*) alpha,dist0
       read(10,*) weight_E,weight_E2,weight_F,delta
       close(10)
...
cccccccc to be different
       ...
       allocate(dist0_ref(num_refm,ntype))
     ...
     &    num_ref(itype)
       ...
       do itype=1,ntype
       open(10,file="Ind_reference."//char(itype+48)//".rev")
       rewind(10)
       read(10,*) 
       do ii=1,num_ref(itype)
       read(10,*) itmp1,itmp2,wtmp1,dist0_ref(ii,itype) 
       enddo
       close(10)
       enddo

       dist0_ref=dist0_ref*dist0
...
!cccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       k=0
       do i=1,sys_num
       read(13,'(a80)',iostat=istat) dfeat_n(i)
       k=k+1
       if(istat/=0) then
         exit
       endif
       ...
       open(10,file=dfeat_n(sys),action="read",access="stream",
     &     form="unformatted")
       rewind(10)
...
!       Gfeat_type(i,k,itype)=exp(-(dist/dist0)**alpha)
       Gfeat_type(i,k,itype)=exp(-(dist/dist0_ref(k,itype))**alpha)
ccccccccccccccc  This might be changed later
       enddo
...
!       dGfeat2(k,i)=-1/xx**2*alpha*dist**(alpha-1)   ! derivative
       ...
       xx=exp(-(dist/dist0_ref(k,itype))**alpha)
       Gfeat2(k,i)=xx
       dGfeat2(k,i)=-alpha/dist0_ref(k,itype)*
     &        (dist/dist0_ref(k,itype))**(alpha-1)*xx
