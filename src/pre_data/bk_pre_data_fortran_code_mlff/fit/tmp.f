...
!      &  rad_atom(i),wp_atom(i)
       ...
       close(10)
        ...
        write(6,*) "Inconsistent ntype from OUT.xp",
     &       ntype_t
        stop
        endif
        read(12) nfeat2
...
!ccccccccccccccccccccccccccccccccccccccccccccc
       ...
       if(iflag.eq.0) then
       do itype=1,ntype
       open(60+itype,file="energyVV.pred0."//char(itype+48))
       rewind(60+itype)
       open(80+itype,file="forceVV.pred0."//char(itype+48))
       rewind(80+itype)
       enddo
       endif
...
!cccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &     form="unformatted")
!  Nee to be extremely careful for access="stream", this means the 
! read sequence and length must be exactly the same as it is written!
! For each line, it cannot miss one variable. 
! The position is not marked by line (record), but by bit !
       rewind(1000+kkk)
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       write(6,*) "nimage_jump,nfeat_type",nimage_jump,nfeat_type
...
900    continue
       ...
       if(iflag.eq.0) then
       open(23,file="loop.inter")
       rewind(23)
       write(23,*) E_lost,iflag
       close(23)
       else
       open(23,file="loop.inter",position="append")
       write(23,*) E_lost
       close(23)
       endif
