...
ccccc Now, we have the new features, we need to calculate the distance to reference state
      ...
      write(22,*) i,j,jtype,jj, SS(j,i,1,jtype)
     ...
     &              weight_E*AA_type(k1,k2,itype)
        ...
        do i=1,ntype
        do j=1,nfeat2N(i)
        write(22,*) AA_type(j,j,i)
        enddo
        enddo
        close(22)
       open(22,file='testAA1')
       rewind(22)
       do i=1,nfeat2totN 
       write(22,*) AA(i,i)
       enddo
