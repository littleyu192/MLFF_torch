...
!cccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       open(70,file="TEST,energyL.pred.tot") 
       rewind(70)
 
       do itype=1,ntype
       open(20+itype,file="TEST.energyL.pred."//char(itype+48))
       rewind(20+itype)
       open(40+itype,file="TEST.forceL.pred."//char(itype+48))
       rewind(40+itype)
       enddo
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      !  test
       do i=1,natom,20
       write(6,*) "energy_pred",i,energy_pred(i)
       enddo
...
ccccccccccccccccccccccccccccccccccccccccccc
       ...
       Esum1=Esum1+energy(iat2)*fact
       Esum2=Esum2+energy_pred(iat2)*fact
       enddo
       energy_group(iat1)=Esum1
       energy_group_pred(iat1)=Esum2
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       write(70,*) Etot, Etot_pred
        ...
        do i=1,natom
        itype=iatom_type(i)
        write(20,*) energy_group(i),energy_group_pred(i)
        write(40+itype,*) force(1,i),force_pred(1,i)
        write(40+itype,*) force(2,i),force_pred(2,i)
        write(40+itype,*) force(3,i),force_pred(3,i)
        enddo

       write(*,*) Etot, Etot_pred

        open(90,file="xatom.test")
        rewind(90)
        write(90,*) natom
        write(90,*) "Lattice vector (Angstrom)"
        write(90,"(3(E25.15,1x))") AL(1,1),AL(2,1),AL(3,1)
        write(90,"(3(E25.15,1x))") AL(1,2),AL(2,2),AL(3,2)
        write(90,"(3(E25.15,1x))") AL(1,3),AL(2,3),AL(3,3)
        write(90,*) "Position"
        do i=1,natom
        write(90,"(i5,3(f20.15,1x), ' 1 1 1')") iatom(i), 
     &   xatom(1,i),xatom(2,i),xatom(3,i)
        enddo
        close(90) 
