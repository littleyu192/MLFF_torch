...
class MdImage(Atoms,Image):
    ...
    def fromImage(anImage,calc=calc_lin,isCheckVar=False,isReDistribute=True):
        ...
        Atoms.__init__(self,
        scaled_positions=np.asarray(self.pos),
        cell=Cell(np.asarray(self.cupyCell)),
        pbc=pm.pbc,
    ...
    def fromAtomConfig(atomConfigPath,calc=calc_lin,isCheckVar=False,isReDistribute=True):
        ...
        Atoms.__init__(self,
        scaled_positions=np.asarray(pos),
        cell=Cell(np.asarray(cell)),
        pbc=pm.pbc,
        numbers=self.atomTypeList)
    ...
    def set_pos_cell(self):
        ...
        scaled_positions=np.array(self.get_scaled_positions(True))
        cell=np.array(np.array(self.cell))
    ...
    def calc_feat(self):
        cell=np.asfortranarray(np.asarray(self.cupyCell.T))
