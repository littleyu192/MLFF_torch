...
print('averaged test square loss = {:.8f}, testing force RMSE loss = {:.8f}, testing etot RMSE loss = {:.8f}, time cost = {}'.format(
    test_square_err, Force_RMSE_error, Etot_RMSE_error, time_cost))

f_err_log = pm.dir_work+'out_test_err.dat'
fid_err_log = open(f_err_log, 'w')
fid_err_log.write('%e %e %e %e %e %s\n' % (test_square_err, Force_RMSE_error,
                  Force_ABS_error, Etot_RMSE_error, Etot_ABS_error, time_cost))
fid_err_log.close()
