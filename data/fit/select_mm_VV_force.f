...
cc for iloop2=2, mm already changed to mm4
       do 7000 iloop2=1,2   
...
cccccccccccccccccccccccccccccccccccccccccc
       ...
       do itype=1,ntype
       open(20+itype,file="energyVV.pred."//char(itype+48))  ! fitting result from last iteration
       rewind(20+itype)
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     & SS(1,1,ixyz,itype),mm_max,SS(1,1,ixyz,itype),mm_max,1.d0,
     & S2(1,1,ixyz,itype),mm_max)
       enddo
       enddo
       endif
