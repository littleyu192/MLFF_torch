...
cccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       xp1(2,ndim1,j,itype)=(xp1(1,ndim1,j,itype)-
     &    xp1(1,ndim1-1,j,itype))*width_fact
...
cccc make sure there is no zero interval
3011    iflag=0
       do id=1,ndim-1
...
cccccccccccccccccccccccccccccccccccccccccccccc
       ...
       xp(2,ndim,j,itype)=(xp(1,ndim,j,itype)-xp(1,ndim-1,j,itype))*
     &       width_fact
       do id=2,ndim-1
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       open(13,file="feat.dist")
       rewind(13)
       do ii=-200,200
       write(13,"(E13.6,2x,10(E13.6,1x))") ii/20.d0,
     &       ((feat_dist(ii,j,itype),j=1,5),itype=1,ntype)
       enddo
       close(13)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
