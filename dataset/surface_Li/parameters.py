...
prefix = r'./'
trainSetDir = r'./bcc'
codedir=r'/share/home/zhangwt/ML/MLFF_torch/2021.9.13'
...
genFeatDir = r'../src/pre_data/gen_feature'
test_ratio = 0
...
learning_rate= 1e-3
batch_size = 40        
rtLossE      = 6.2     # weight for energy, NN fitting 各个原子能量所占的权重
rtLossF      = 4.31     # weight for force, NN fitting 各个原子所受力所占的权重
rtLossEtot      = 53.9     # weight for Etot, NN fitting 各个原子所受力所占的权重
bias_corr = True
